...
class Xml2CoCo:
    ...
    def save_coco_json(self, instance, save_path):
        json.dump(instance, open(save_path, 'a'), ensure_ascii=False, indent=2)  # indent=2 更加美观显示
...
if __name__ == '__main__':
    csv_file = r"G:\Dataset\min40x40/train.txt"
    image_dir = r"G:\Dataset\min40x40\train\IMG/"
    saved_coco_path = "G:\Dataset\min40x40/"
    # 整合csv格式标注文件
    ...
    # 把训练集转化为COCO的json格式
    l2c_train = Xml2CoCo(image_dir=image_dir, total_annos=total_csv_annotations)
    ...
    # 把验证集转化为COCO的json格式
    l2c_val = Xml2CoCo(image_dir=image_dir, total_annos=total_csv_annotations)
